...
const to_public_key = new web3_js_1.PublicKey("3BUoiPCqw77faEXhc3jnXw8DKkTE1thpG1H45zwzvt92");
(() => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, airdrop_1.airdrop)(from_keypair.publicKey.toString(), 10);
    yield transferSol(from_keypair, to_public_key, 10);
}))();
